...
public final class ItemTransactionBinding implements ViewBinding {
  ...
  private ItemTransactionBinding(@NonNull LinearLayout rootView, @NonNull TextView tvAmount,
      @NonNull TextView tvDate, @NonNull TextView tvIcon, @NonNull TextView tvName) {
  ...
  public static ItemTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTransactionBinding((LinearLayout) rootView, tvAmount, tvDate, tvIcon, tvName);
    }
